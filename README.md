...
If you're interested in becoming a maintainer, please see [this GitHub issue](https://github.com/manorrock/bengal-book/issues/20) for details on how to express your interest and what's involved. Note that new maintainers will need to migrate the project to a new namespace, as the Manorrock branding will remain with Manorrock.com.
...
Bengal is a language that is kept simple on purpose. You should be able to learn
the syntax relatively quickly and be up and running in no time!
